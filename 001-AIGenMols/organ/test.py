...
organ_params = {
    'PRETRAIN_GEN_EPOCHS': 1, 'PRETRAIN_DIS_EPOCHS': 1, 'MAX_LENGTH': 60, 'LAMBDA': 0.5, "DIS_EPOCHS": 2, 'SAMPLE_NUM': 6400, 'WGAN':True}
...
ord_dict = model.load_training_set('data/FDA-H.csv')
# model.load_prev_pretraining('pretrain_ckpt/qm9-5k_pretrain_ckpt')
#model.set_training_program(
#    ['druglikeliness'], [100])
model.set_training_program(['druglikeliness', 'synthesizability'], [2, 2])
model.load_metrics()
