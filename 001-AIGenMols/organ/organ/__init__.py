...
class ORGAN(object):
    ...
    def load_metrics(self):
        ...
        for m in met:
            ...
            #print('%%%%%%%%%%%%%%^^^^^^^^^^^^^^^^^^^^^^^^^^********************  ', load_fun)
            #print('%%%%%%%%%%%%%%^^^^^^^^^^^^^^^^^^^^^^^^^^*+++++++++++++++++++  ', load_fun())
            ## No brackets means call function !!!!!!
            #args = load_fun
            ### brackets means carry out the function !!!!!!
            args = load_fun()
